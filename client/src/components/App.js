    ...
    return arts ? (
      <Container className="main-container">
        ...
        <Header as="h2" icon textAlign="center" color="teal">
          ...
          <Header.Content>List of Arts</Header.Content>
        </Header>
        <Divider hidden section />
        <div>
          <Button primary floated="right" as={Link} to="/artists/new">
            Add artist
          </Button>
          <Button primary floated="right" as={Link} to="/arts/new">
            Add art
          </Button>
        </div>
        <Divider hidden section />
                ...
                {Object.keys(arts).map(key => {
                  return (
                    <Button
                      ...
                      fluid
                      key={key}
                      onClick={() => this.getArt(arts[key].id)}
                    >
                      {arts[key].name}
                    </Button>
                  );
